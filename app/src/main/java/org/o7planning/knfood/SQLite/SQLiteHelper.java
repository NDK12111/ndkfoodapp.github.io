...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String sql3 = "CREATE TABLE bills("+
                "id INTEGER PRIMARY KEY AUTOINCREMENT,"+
                "title TEXT, time TEXT, price REAL,"+
                "amount INTEGER, status TEXT, rating REAL)";
        String sql4 = "CREATE TABLE stores("+
                "id INTEGER PRIMARY KEY AUTOINCREMENT,"+
                "title TEXT, address TEXT, phone text)";
        String sql5 = "CREATE TABLE billdetails("+
                "id INTEGER PRIMARY KEY AUTOINCREMENT,"+
                "billid INTEGER,totalprice REAL)";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        String sql = "DROP TABLE IF EXISTS foods";
        String sql1 = "DROP TABLE IF EXISTS vouchers";
        String sql2 = "DROP TABLE IF EXISTS category";
        String sql3 = "DROP TABLE IF EXISTS bills";
        String sql4 = "DROP TABLE IF EXISTS stores";
        String sql5 = "DROP TABLE IF EXISTS billdetails";
        sqLiteDatabase.execSQL(sql);
        sqLiteDatabase.execSQL(sql1);
        sqLiteDatabase.execSQL(sql2);
        sqLiteDatabase.execSQL(sql3);
